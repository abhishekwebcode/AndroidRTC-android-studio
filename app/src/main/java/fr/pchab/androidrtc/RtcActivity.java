...
public class RtcActivity extends Activity implements WebRtcClient.RtcListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intent!=null && intent.hasExtra("chatId")) {
            callerId = intent.getStringExtra("chatId");
        }
        checkPermissions();
    }
    ...
    public void call(String callId) {
        ...
        msg.putExtra(Intent.EXTRA_TEXT, "Enter this chat id to chat with me: *  "+callId+"  *");
        msg.setType("text/plain");
        startActivityForResult(Intent.createChooser(msg, "Share Chat ID :"), VIDEO_CALL_SENT);
    }
